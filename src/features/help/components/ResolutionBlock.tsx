  ...
  return (
    <>
      <div className="help-resolution">
        ...
        <p style={{ fontSize: "13px", color: "rgba(255,255,255,0.6)", marginTop: "10px", fontWeight: 400 }}>
          {t("resolution.contact_hint")}
        </p>
      </div>
      {showThanks && (
        <Toast message={t("resolution.thanks")} show={showThanks} onClose={() => setShowThanks(false)} type="success" />
      )}
    </>
  );
}
